    ...
    <div class="container mx-auto flex flex-col items-center justify-center p-6">
      <div class="border border-black p-3 rounded">
        ...
        <form action="" method="PUT">
          ...
          <input type="submit" name="submit" value="UPDATE" class="block mx-auto bg-black text-white rounded p-1 cursor-pointer">
        </form>
      </div>
    </div>
  </section>

  <!-- COLLECT FORM DATA IN JS, CHECK IF EMPTY IF NOT JSON ENCODE THEN SEND TO BACKEND/ENDPOINT -->
